...
#### 1.2.2 Colored PCA by tyrosine kinase inhibitors  
...
load("C:/Users/Dori/Desktop/Studium/SS_19/Bioinfo Projekt/GitHub/project-02-group-02#project-02-group-02/data/Schaubild_RGES.png")
```
...
### 4.2. Mean values - different criteria
...
### 5.1. Do our RGES also positively correlate to IC50?
...
# 6. Conclusion
```{r, echo=FALSE, include=TRUE}
load("C:/Users/Dori/Desktop/Studium/SS_19/Bioinfo Projekt/GitHub/project-02-group-02#project-02-group-02/data/Timeline.png")
```
