...
````{r}
lowest.FC = readRDS("/Users/teresa.vonlinde/Documents/Uni/4.Semester/Bioinfo/GitHub/project-02-group-02/lowestFC.rds")
par(mar = c(5, 7, 5, 5))
...
highest.FC = readRDS("/Users/teresa.vonlinde/Documents/Uni/4.Semester/Bioinfo/GitHub/project-02-group-02/highestFC.rds")
par(mar = c(5, 10, 5, 5))
...
````{r}
biomarker2 = readRDS("/Users/teresa.vonlinde/Documents/Uni/4.Semester/Bioinfo/GitHub/project-02-group-02/biomarker2.rds")
`````
...
`````{r}
double.biomarker = readRDS("/Users/teresa.vonlinde/Documents/Uni/4.Semester/Bioinfo/GitHub/project-02-group-02/doublebiomarker.rds")
double.biomarker.FC = readRDS("/Users/teresa.vonlinde/Documents/Uni/4.Semester/Bioinfo/GitHub/project-02-group-02/double.biomarker.FC.rds")
`````
...
kmeans= kmeans(x = t(double.biomarker.FC), centers = 4, nstart = 10)
````

#heatmap with annotation - annotation klappt irgendwie noch nicht
```{r}
par(mar = c(10,5,7,5))
